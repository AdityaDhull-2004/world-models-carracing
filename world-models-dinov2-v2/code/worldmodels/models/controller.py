...
class Controller:
    def __init__(self, z_dim=32, h_dim=256, action_dim=3):
        self.z_dim      = z_dim  # Now 32
        self.h_dim      = h_dim  # Now 256
        self.action_dim = action_dim
        
        # Calculate input_dim based on the values above
        self.input_dim  = self.z_dim + self.h_dim # This will be 288
        
        self.W = np.zeros((self.action_dim, self.input_dim), dtype=np.float32)
